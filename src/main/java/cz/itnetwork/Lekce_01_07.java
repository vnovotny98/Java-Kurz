...
public class Lekce_01_07 {
    ...
    public static void main(String[] args) {
        ...
        */
        ...
        System.out.println(prazdno.isEmpty());
        ...
        */
        ...
        System.out.println("Zadal jste číslo: " + vstup);
        System.out.println("Text po funkci trim: " + vstup.trim());
        int cislo = Integer.parseInt(vstup.trim());
        System.out.println("Převedel jsem zadaný text na číslo parsováním, zadal jste: " + cislo);
        */
